if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("M1tqyYield is already running!", 0)
    return
end
...
if not game:IsLoaded() then
    ...
    notLoaded.Text = "M1tqyYield Yield is waiting for the game to load"
    game.Loaded:Wait()
    notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "M1tqyYield v" .. currentVersion
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			toClipboard("https://t.me/MitqyDev")
		...
		inviteButton.Text = "https://t.me/MitqyDev"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'tg / support / help', DESC = 'Invite to the M1tqyYield channel.'}
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if everyClipboard then
		...
		notify('TG Invite', 'https://t.me/MitqyDev')
	end
	if httprequest then
		httprequest({
